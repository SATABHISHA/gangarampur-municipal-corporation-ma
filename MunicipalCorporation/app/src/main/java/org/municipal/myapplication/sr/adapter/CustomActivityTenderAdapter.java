...
public class CustomActivityTenderAdapter extends RecyclerView.Adapter<CustomActivityTenderAdapter.MyViewHolder> {
    ...
    public CustomActivityTenderAdapter(Context ctx, ArrayList<UserModelClass> userModelClassArrayList){
    ...
    @NonNull
    @Override
    public CustomActivityTenderAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_tender, parent, false);
        CustomActivityTenderAdapter.MyViewHolder holder = new CustomActivityTenderAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CustomActivityTenderAdapter.MyViewHolder holder, int position) {
//        holder.tv_headline.setText(userModelClassArrayList.get(position).getNotice_heading());
        holder.tv_headline.setText(userModelClassArrayList.get(position).getTender_heading());
...
//                    String url = userModelClassArrayList.get(position).getNews_image();
                    String url = userModelClassArrayList.get(position).getTender_image();
                    ...
                    if (CheckForSDCard.isSDCardPresent()) {
                        ...
                        if (EasyPermissions.hasPermissions(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            //Get the URL entered
                            new CustomActivityTenderAdapter.DownloadFile().execute(url);
