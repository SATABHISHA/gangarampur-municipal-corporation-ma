...
public class CustomActivityEventAdapter extends RecyclerView.Adapter<CustomActivityEventAdapter.MyViewHolder> {
    ...
    public CustomActivityEventAdapter(Context ctx, ArrayList<UserModelClass> userModelClassArrayList){
    ...
    @NonNull
    @Override
    public CustomActivityEventAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_event, parent, false);
        CustomActivityEventAdapter.MyViewHolder holder = new CustomActivityEventAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CustomActivityEventAdapter.MyViewHolder holder, int position) {
//        holder.tv_headline.setText(userModelClassArrayList.get(position).getNotice_heading());
        holder.tv_headline.setText(userModelClassArrayList.get(position).getEvents_heading());
...
//                    String url = userModelClassArrayList.get(position).getNews_image();
                    String url = userModelClassArrayList.get(position).getEvents_image();
                    ...
                    if (CheckForSDCard.isSDCardPresent()) {
                        ...
                        if (EasyPermissions.hasPermissions(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            //Get the URL entered
                            new CustomActivityEventAdapter.DownloadFile().execute(url);
