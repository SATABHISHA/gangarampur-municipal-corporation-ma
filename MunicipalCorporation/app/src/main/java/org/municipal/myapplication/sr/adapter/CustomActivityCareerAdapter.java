...
public class CustomActivityCareerAdapter extends RecyclerView.Adapter<CustomActivityCareerAdapter.MyViewHolder> {
    ...
    public CustomActivityCareerAdapter(Context ctx, ArrayList<UserModelClass> userModelClassArrayList){
    ...
    @NonNull
    @Override
    public CustomActivityCareerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_career, parent, false);
        CustomActivityCareerAdapter.MyViewHolder holder = new CustomActivityCareerAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CustomActivityCareerAdapter.MyViewHolder holder, int position) {
//        holder.tv_headline.setText(userModelClassArrayList.get(position).getNotice_heading());
        holder.tv_headline.setText(userModelClassArrayList.get(position).getCareer_heading());
...
//                    String url = userModelClassArrayList.get(position).getNews_image();
                    String url = userModelClassArrayList.get(position).getCareer_image();
                    ...
                    if (CheckForSDCard.isSDCardPresent()) {
                        ...
                        if (EasyPermissions.hasPermissions(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            //Get the URL entered
                            new CustomActivityCareerAdapter.DownloadFile().execute(url);
