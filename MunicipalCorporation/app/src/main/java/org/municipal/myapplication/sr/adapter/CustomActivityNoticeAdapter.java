...
public class CustomActivityNoticeAdapter extends RecyclerView.Adapter<CustomActivityNoticeAdapter.MyViewHolder>  {
    ...
    public CustomActivityNoticeAdapter(Context ctx, ArrayList<UserModelClass> userModelClassArrayList){
    ...
    @NonNull
    @Override
    public CustomActivityNoticeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_noticefeed, parent, false);
        CustomActivityNoticeAdapter.MyViewHolder holder = new CustomActivityNoticeAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CustomActivityNoticeAdapter.MyViewHolder holder, int position) {
...
//                    String url = userModelClassArrayList.get(position).getNews_image();
                    String url = userModelClassArrayList.get(position).getNotice_image();
