package org.municipal.myapplication.sr.notice;
...
public class NoticeActivityHome extends AppCompatActivity {
    ArrayList<UserModelClass> arrayList = new ArrayList<>();
    RecyclerView mRecyclerView;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.noticehome);
        ...
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NoticeActivityHome.this,ActivityMain.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                NoticeActivityHome.this.finish();
//                onBackPressed();
            }
        });
        //============toolbar code ends===============
    ...
    public void loadData(){
        String url = "http://gangarampur.sambadsaradin.com/Gangarampur_ci/api/fetch_notice";
        final ProgressDialog loading = ProgressDialog.show(NoticeActivityHome.this, "Loading", "Please wait...", true, false);
...
//              userModelclassList.clear();
        ...
        try{
            ...
            for (int i=0; i <jsonArray.length(); i++){
                ...
                userModelClass.setNotice_heading(jsonObject.getString("notice_heading"));
                userModelClass.setNotice_content(jsonObject.getString("notice_content"));
                userModelClass.setNotice_image(jsonObject.getString("notice_image"));
            ...
            mRecyclerView.setAdapter(new CustomActivityNoticeAdapter(NoticeActivityHome.this,arrayList));
            loading.dismiss();
