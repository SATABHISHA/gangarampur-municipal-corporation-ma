...
public class CustomActivityFacilityAdapter extends RecyclerView.Adapter<CustomActivityFacilityAdapter.MyViewHolder> {
    ...
    public CustomActivityFacilityAdapter(Context ctx, ArrayList<UserModelClass> userModelClassArrayList){
    ...
    @NonNull
    @Override
    public CustomActivityFacilityAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycler_facility, parent, false);
        CustomActivityFacilityAdapter.MyViewHolder holder = new CustomActivityFacilityAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CustomActivityFacilityAdapter.MyViewHolder holder, int position) {
//        holder.tv_headline.setText(userModelClassArrayList.get(position).getNotice_heading());
        holder.tv_headline.setText(userModelClassArrayList.get(position).getFacility_heading());
...
//                    String url = userModelClassArrayList.get(position).getNews_image();
                    String url = userModelClassArrayList.get(position).getFacility_image();
                    ...
                    if (CheckForSDCard.isSDCardPresent()) {
                        ...
                        if (EasyPermissions.hasPermissions(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            //Get the URL entered
                            new CustomActivityFacilityAdapter.DownloadFile().execute(url);
